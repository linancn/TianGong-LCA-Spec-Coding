...
def _build_section_prompt() -> str:
    ...
    process_guidelines = (
        ...
        "abbreviations(“Electric power supply; Grid electricity; Utility electricity”).\n"
        "`zh_synonyms`: semicolon-separated Chinese equivalents,（如“电力；电网供电”），与 `en_synonyms` 含义对应且不重复 `basename`.\n"
